...
<script type="text/javascript">
	...
	$(function() {
		...
		$tabs = $("#tabs")
				.tabs(
						{
							tabTemplate : '<li><a href="#{href}">#{label}</a> <span class="ui-icon ui-icon-close" title="Tab schließen">Remove Tab</span></li>',
		...
		$('#tabs li a')
				.live(
						...
						function() {
							var new_name = prompt(
									"Geben Sie den neuen Namen für den Tab ein",
									"");
							if (new_name) {
		...
		//hin und herschalten zwischen domains hinzufügen
    ...
    <div id="tabs">
        ...
        <ul id="tab-list">
            <li id="prev_tab"><span
                ...
                title="Vorherigen Tab auswählen (Strg + Alt + Pfeiltaste links)">Previous
                    Tab</span></li>
            <li id="next_tab"><span
                class="ui-icon ui-icon-triangle-1-e"
                title="Nächsten Tab auswählen (Strg + Alt + Pfeiltaste rechts)">Next
                    Tab</span></li>
            <li><a href="#tabs-1">Neuer Tab</a> <span
                class="ui-icon ui-icon-close" title="Tab schließen">Remove
                    Tab</span></li>
            <li id="add_tab"><span
        ...
        <div class="domain-container" style="padding: 0;">
            <div class="domain-switch">
                <span id="prev_page"
                    ...
                    class="ui-icon ui-icon-triangle-1-e"
                    title="Nächste Domain aus Auswahl anzeigen">Next
                    Page</span>
            </div>
            <div class="domain">
                <!-- <h2>www.example.com</h2> -->
                <select data-placeholder="Domain auswählen..."
