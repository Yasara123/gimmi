...
\it{set PrintMode latex;} das Ausgabeformat auf \LaTeX umgestellt, damit die
...
\begin{enumerate}
  ...
  \item \it{@[pos='N(E|N)' \& word!="Ministerpräsident.*"]]} \\
...
mit \it{cut} beschränkt. Durch \it{cut 4} wurde die Ausgabe auf Kombinationen
beschränkt, die mindestens 4 mal auftreten. Der Wert 4 wurde zuvor manuell
bestimmt, indem der obige Befehl ohne den \it{cut} Befehl verwendet wurde. Die
...
nach ihrer Häufigkeit sortiert. Mit \it{cut 35} wurde die Ausgabe auf Nomen
...
Adjektivs gruppiert. Mit \it{cut 2} wird die Ausgabe auf Adjektive begrenzt, die
